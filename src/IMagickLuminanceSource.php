...
//@Override
    public function getRow($y, $row=null) {
        ...
        $row = array_copy($this->luminances,$offset, $row, 0, $width);
        return $row;
    }
...
// If the width matches the full width of the underlying data, perform a single copy.
        if ($width == $this->dataWidth) {
            $matrix = array_copy($this->luminances, $inputOffset, $matrix, 0, $area);
            return $matrix;
        }
...
// Otherwise copy one cropped row at a time.
        ...
        for ($y = 0; $y < $height; $y++) {
            ...
            $matrix = array_copy($rgb, $inputOffset, $matrix, $outputOffset, $width);
