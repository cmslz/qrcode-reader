...
namespace Cmslz\QrcodeReader\Qrcode;

require_once('Detector/Detector.php');


use Cmslz\QrcodeReader\ChecksumException;

use Cmslz\QrcodeReader\FormatException;
use Cmslz\QrcodeReader\NotFoundException;
use Cmslz\QrcodeReader\Reader;
use Cmslz\QrcodeReader\Result;
use Cmslz\QrcodeReader\Common\BitMatrix;
use Cmslz\QrcodeReader\Qrcode\Decoder\Decoder;
use Cmslz\QrcodeReader\Qrcode\Detector\Detector;
...
class QRCodeReader implements Reader
{
     ...
     * case.
     * @see com.google.Cmslz\QrcodeReader.datamatrix.DataMatrixReader#extractPureBits(BitMatrix)
